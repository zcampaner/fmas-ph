			...
			<form class="form-horizontal" method="post">
				<fieldset>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" name="username" value="<?php echo $u->username; ?>" required="required" class="span6 typeahead" data-provide="typeahead" >
						</div>
					</div>
					<div class="control-group">
						<label class="control-label" for="typeahead">Full Name </label>
						<div class="controls">
							<input type="text" name="fullname" required="required" value="<?php echo $u->fullname; ?>" class="span6 typeahead" data-provide="typeahead" >
						</div>
					</div>
				<?php endforeach; ?>
